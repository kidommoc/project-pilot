...
One file per module. Stored in `docs/knowledge/interfaces/`.
...
## Layer / Domain
Which architecture layer and domain this module belongs to (must match `docs/knowledge/architecture.md`).
